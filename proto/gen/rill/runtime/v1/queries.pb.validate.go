...
// Validate checks the field values on MetricsViewFilter_HavingCond with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *MetricsViewFilter_HavingCond) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on MetricsViewFilter_HavingCond with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// MetricsViewFilter_HavingCondMultiError, or nil if none found.
func (m *MetricsViewFilter_HavingCond) ValidateAll() error {
	return m.validate(true)
}

func (m *MetricsViewFilter_HavingCond) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return MetricsViewFilter_HavingCondMultiError(errors)
	}

	return nil
}

// MetricsViewFilter_HavingCondMultiError is an error wrapping multiple
// validation errors returned by MetricsViewFilter_HavingCond.ValidateAll() if
// the designated constraints aren't met.
type MetricsViewFilter_HavingCondMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m MetricsViewFilter_HavingCondMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m MetricsViewFilter_HavingCondMultiError) AllErrors() []error { return m }

// MetricsViewFilter_HavingCondValidationError is the validation error returned
// by MetricsViewFilter_HavingCond.Validate if the designated constraints
// aren't met.
type MetricsViewFilter_HavingCondValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e MetricsViewFilter_HavingCondValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e MetricsViewFilter_HavingCondValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e MetricsViewFilter_HavingCondValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e MetricsViewFilter_HavingCondValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e MetricsViewFilter_HavingCondValidationError) ErrorName() string {
	return "MetricsViewFilter_HavingCondValidationError"
}

// Error satisfies the builtin error interface
func (e MetricsViewFilter_HavingCondValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sMetricsViewFilter_HavingCond.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = MetricsViewFilter_HavingCondValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = MetricsViewFilter_HavingCondValidationError{}
